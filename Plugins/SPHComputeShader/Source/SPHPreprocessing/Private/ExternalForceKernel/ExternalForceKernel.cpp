...
void FExternalForceKernelInterface::DispatchRenderThread(FRHICommandListImmediate& RHICmdList, FExternalForceKernelDispatchParams Params, TFunction<void(int OutputVal)> AsyncCallback) {
